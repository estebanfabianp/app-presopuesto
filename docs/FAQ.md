...
**App Presupuesto** es una **aplicación de escritorio nativa** desarrollada con Python y Flet. No es una aplicación web ni requiere navegador. Se ejecuta directamente en tu computadora con interfaz gráfica moderna.

### ¿Qué tecnologías utiliza el proyecto?
- **Lenguaje Principal**: Python 3.8+
- **Framework UI**: Flet (interfaz gráfica multiplataforma)
...
- Scripts SQL de inicialización (`database/scripts/create/`)
...
Consulta el [Roadmap detallado](../documentacion/roadmap.md) para información completa sobre:
...
Consulta la [Guía de Contribución](../documentacion/CONTRIBUTING.md) para detalles completos.
...
- 🗄️ **Base de Datos**: [BASE_DATOS.md](BASE_DATOS.md)
- 👤 **Guía de Usuario**: [USER_GUIDE.md](USER_GUIDE.md)
- 🔒 **Seguridad**: [../documentacion/SECURITY.md](../documentacion/SECURITY.md)
- 🚀 **Roadmap**: [../documentacion/roadmap.md](../documentacion/roadmap.md)
...
3. **Changelog**: Revisar [CHANGELOG.md](../documentacion/CHANGELOG.md) regularmente
