...
![Diagrama ER](../base_de_datos/script_bd/create/modelo_ENR.png)
...
Para detalles adicionales, consulta los scripts SQL en `/base_de_datos/script_bd/create/` y la documentación técnica del proyecto.
#archivoMD